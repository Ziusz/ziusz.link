    ...
    <body class="min-h-dvh bg-zinc-950 font-sans text-zinc-100 antialiased">
        <main class="mx-auto flex min-h-dvh w-full max-w-5xl flex-col gap-8 px-6 py-10">
            ...
            <section class="rounded-md border border-zinc-800 bg-zinc-900/50 p-6">
                ...
                <div class="mt-5">
                    <a href="{{ route('admin.links.index') }}" class="inline-flex h-10 items-center justify-center rounded-md bg-accent px-4 text-sm font-semibold text-accent-foreground transition hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500/60">
                        {{ __('Open links') }}
                    </a>
                </div>
            </section>
